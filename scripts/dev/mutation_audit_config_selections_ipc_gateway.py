...
FOCUSED_TEST_SELECTIONS_IPC_GATEWAY: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("venus_evcharger/dbus_adapter/tick_policy.py", ("tests/test_dbus_adapter_tick_policy_contracts.py",)),
    ...
    ("venus_evcharger/dbus_adapter/health/latency.py", ("tests/test_dbus_adapter_health_latency_contracts.py",)),
