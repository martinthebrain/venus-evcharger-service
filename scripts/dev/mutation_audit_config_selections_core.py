...
_STORAGE_CLUSTER_RESILIENCE_TESTS = ('tests/test_storage_cluster_resilience_contracts.py',)
_STORAGE_GATEWAY_BOUNDARY_TESTS = ('tests/test_storage_gateway_boundary_contracts.py',)
...
FOCUSED_TEST_SELECTIONS_CORE: tuple[tuple[str, tuple[str, ...]], ...] = (('venus_evcharger/app/', ('tests/test_app_bootstrap_support.py',)),
 ...
 ('venus_evcharger/dbus_gateway_cache.py',
  ('tests/test_dbus_gateway_primitives.py', 'tests/test_dbus_adapter_freshness_contracts.py')),
 ...
 ('venus_evcharger/dbus_adapter/process/identity.py', ('tests/test_dbus_adapter_process_identity_contracts.py',)),
 ...
 ('venus_evcharger/inputs/dbus.py',
   ...
   *_STORAGE_GATEWAY_BOUNDARY_TESTS)),
 ...
 ('venus_evcharger/inputs/helper/sources_dbus_gateway.py', ('tests/test_auto_input_helper_gateway_contracts.py',)),
 ...
 ('venus_evcharger/inputs/helper/sources_dbus_resolve.py',
  ('tests/test_auto_input_helper_sources_contracts.py',)),
 ('venus_evcharger/inputs/helper/sources_pv_grid.py', ('tests/test_auto_input_helper_sources_contracts.py',)),
 ('venus_evcharger/inputs/helper/subscriptions.py', ('tests/test_auto_input_helper_subscription_contracts.py',)),
 ('venus_evcharger/inputs/pv.py', ('tests/test_venus_evcharger_dbus_inputs_controller.py',)),
 ('venus_evcharger/inputs/storage.py',
  ('tests/test_venus_evcharger_dbus_inputs_controller.py',
   'tests/test_input_edge_contracts.py',
   *_STORAGE_CLUSTER_RESILIENCE_TESTS)),
 ('venus_evcharger/inputs/storage_support.py',
  ('tests/test_venus_evcharger_dbus_inputs_controller.py',
   'tests/test_input_edge_contracts.py',
   *_STORAGE_GATEWAY_BOUNDARY_TESTS)),
 ('venus_evcharger/inputs/supervisor.py',
  ('tests/test_venus_evcharger_auto_input_supervisor.py', 'tests/test_input_edge_contracts.py')),
 ...
 ('venus_evcharger/inputs/supervisor_snapshot_validation.py',
  ('tests/test_auto_input_supervisor_snapshot_validation_contracts.py', 'tests/test_input_edge_contracts.py')),
 ...
 ('venus_evcharger/ports/dbus.py',
  ('tests/test_ports_dbus_contracts.py', *_STORAGE_GATEWAY_BOUNDARY_TESTS)),
