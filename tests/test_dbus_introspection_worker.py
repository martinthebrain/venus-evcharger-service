...
class DbusIntrospectionWorkerTests(unittest.TestCase):
    ...
    def test_worker_edges_for_config_parent_bus_resources_quiet_hours_and_main(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            bus = _FakeBus(["com.victronenergy.pvinverter.http_48", "com.victronenergy.battery.tty0"])
            with patch.object(worker_module, "dbus", _FakeDbus(bus)):
                ...
                self.assertEqual(worker._explicit_or_prefixed_services("missing", "com.victronenergy.battery", bus.names), [])
    ...
    def test_worker_request_and_error_edges(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(worker_module, "dbus", _FakeDbus(bus)):
                ...
                self.assertIs(listing_worker._get_system_bus(), listing_worker._system_bus)
