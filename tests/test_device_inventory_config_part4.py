...
class _DeviceInventoryConfigTestsPart4:
...
"""
    ...
    def test_section_parsers_use_explicit_schema_field_names(self) -> None:
        profile_config = self._FakeConfig(
            ["Profile:p1"],
            {
                "Profile:p1": self._FakeSection(
                    "Profile:p1",
                    {
                        "Label": "Profile 1",
                        "Vendor": "Vendor 1",
        ...
        capability_config = self._FakeConfig(
            ["Capability:p1:meter", "Capability:p1:switch"],
            {
                "Capability:p1:meter": self._FakeSection(
                    "Capability:p1:meter",
                    {
                        "Kind": "meter",
                        "AdapterType": "template_meter",
                ...
                "Capability:p1:switch": self._FakeSection(
        ...
        device_config = self._FakeConfig(
            ["Device:d1"],
            {
                "Device:d1": self._FakeSection(
                    "Device:d1",
                    {
                        "Profile": "p1",
                        "Label": "Device 1",
        ...
        default_enabled_config = self._FakeConfig(
            ["Device:d2"],
            {
                "Device:d2": self._FakeSection(
                    "Device:d2",
                    {
                        "Profile": "p1",
                        "Label": "Device 2",
        ...
        binding_config = self._FakeConfig(
            ["Binding:b1"],
            {
                "Binding:b1": self._FakeSection(
                    "Binding:b1",
                    {
                        "Role": "measurement",
                        "Label": "Binding 1",
        ...
        member_config = self._FakeConfig(
            ["BindingMember:b1:m1"],
            {
                "BindingMember:b1:m1": self._FakeSection(
                    "BindingMember:b1:m1",
                    {
                        "Device": "d1",
                        "Capability": "meter",
    ...
    def test_section_parsers_report_invalid_section_names_with_full_label(self) -> None:
        invalid_capability = self._FakeConfig(
            ["Capability:p1"],
            {"Capability:p1": self._FakeSection("Capability:p1", {})},
        )
        self._assert_inventory_error(
        ...
        invalid_member = self._FakeConfig(
            ["BindingMember:b1"],
            {"BindingMember:b1": self._FakeSection("BindingMember:b1", {})},
        )
        self._assert_inventory_error(
    ...
    def test_section_parsers_reject_lowercase_required_schema_keys(self) -> None:
        lowercase_profile = self._FakeConfig(
            ["Profile:p1"],
            {"Profile:p1": self._FakeSection("Profile:p1", {"label": "Profile 1"})},
        )
        self._assert_inventory_error("missing required key Profile:p1.Label", _profiles, lowercase_profile)

        lowercase_capability = self._FakeConfig(
            ["Capability:p1:meter"],
            {
                "Capability:p1:meter": self._FakeSection(
                    "Capability:p1:meter",
        ...
        lowercase_device = self._FakeConfig(
            ["Device:d1"],
            {"Device:d1": self._FakeSection("Device:d1", {"profile": "p1", "label": "Device 1"})},
        )
        self._assert_inventory_error("missing required key Device:d1.Profile", _devices, lowercase_device)

        lowercase_binding = self._FakeConfig(
            ["Binding:b1"],
            {
                "Binding:b1": self._FakeSection(
                    "Binding:b1",
        ...
        lowercase_member = self._FakeConfig(
            ["BindingMember:b1:m1"],
            {
                "BindingMember:b1:m1": self._FakeSection(
                    "BindingMember:b1:m1",
