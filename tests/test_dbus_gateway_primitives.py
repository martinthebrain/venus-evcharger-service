...
class DbusGatewayPrimitiveTests(unittest.TestCase):
    ...
    def test_command_queue_class_maps_gateway_workloads(self) -> None:
        ...
        cases = [
            ...
            ({"kind": "publish_fields", "fields": {"ac_power_w": 1200.0}}, "gui-critical-publish"),
            ({"kind": "publish_fields", "fields": {"session_time_s": 30}}, "gui-critical-publish"),
            ({"kind": "publish_fields", "fields": {"unknown_field": 1}}, "local-publish"),
            ({"kind": "publish_fields", "fields": []}, "local-publish"),
