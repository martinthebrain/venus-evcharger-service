...
class TestCoreContractsBootstrapContracts(unittest.TestCase):
    ...
    def test_full_failed_status_shape_contract(self) -> None:
        payload = {
            ...
            "old_source_commit": " old-commit ",
            "new_source_commit": " new-commit ",
            "source_repo": " owner/repository ",
            "source_channel": " stable ",
            "deployment_receipt_path": " /state/receipt.json ",
            "work_storage": " ram ",
            "work_root": " /tmp/updater ",
            "bootstrap_entrypoint_path": " /data/venus-evcharger/install.sh ",
