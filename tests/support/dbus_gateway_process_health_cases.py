...
class GatewayProcessHealthCases(GatewayAdapterContractCase):
    ...
    def test_health_regulation_edges_reduce_burst_and_ignore_bad_cached_numbers(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            install_mock(fresh_adapter, "enqueue_background_introspection_if_due", MagicMock())
            install_mock(fresh_adapter, "poll_one_due_read_once", MagicMock(return_value=False))
            install_mock(
            ...
            install_mock(fresh_adapter, "refresh_services_if_due_once", MagicMock(return_value=False))
