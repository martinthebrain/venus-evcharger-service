    ...
    def test_bootstrap_installer_defaults_to_hash_validated_updater_when_manifest_is_unset(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for rel_path, content in (
                ...
                ("deploy/venus/bin/venus-evcharger-auto-input-helper", "auto-input-helper-binary\n"),
                ("deploy/venus/bin/venus-evcharger-dbus-adapter", "dbus-adapter-binary\n"),
                ("deploy/venus/bin/venus-evcharger-forensic-observer", "observer-binary\n"),
                ("deploy/venus/service_venus_evcharger_observer/run", "#!/bin/sh\n"),
                ("deploy/venus/service_venus_evcharger_observer/log/run", "#!/bin/sh\n"),
