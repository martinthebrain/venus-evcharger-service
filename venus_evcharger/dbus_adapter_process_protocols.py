...
class DbusAdapterHealthContext(Protocol):
    ...
    def _queue_class_health(self, pending: list[tuple[str, dict[str, Any]]], now: float) -> dict[str, Any]: ...
    def _oldest_command_age(self, commands: list[tuple[str, dict[str, Any]]], now: float) -> float: ...
