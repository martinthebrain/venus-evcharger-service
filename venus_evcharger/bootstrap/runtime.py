...
class RuntimeInitializer:
    ...
    def prepare_runtime_state(self) -> None:
        """Initialize shared runtime state and resolve configured backends."""
        require_controller_owner(self._service).prepare_runtime_state()
    ...
    def restore_runtime_state(self) -> None:
        """Restore RAM-backed state after foundational worker setup."""
        svc = self._service
