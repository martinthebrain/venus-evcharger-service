...
REMOVABLE_STORAGE_MAINTENANCE_LOCK_PATH="${VENUS_REMOVABLE_STORAGE_MAINTENANCE_LOCK_PATH:-/run/lock/removable-storage-maintenance.lock}"
REMOVABLE_STORAGE_MAINTENANCE_WAIT_SECONDS="${VENUS_EVCHARGER_UPDATER_STORAGE_MAINTENANCE_WAIT_SECONDS:-300}"
...
RESOURCE_MIN_MEM_AVAILABLE_PERSISTENT_KB="${VENUS_EVCHARGER_UPDATER_PERSISTENT_MIN_MEM_AVAILABLE_KB:-32768}"
